    ...
    <section class="team-section">
        ...
        <div class="team">
            <div class="team-member">
                <img src="<?=base_url('assets/images/mutya.jpg')?>" alt="Team Member 1">
                <h3>Jomil Mutya</h3>
                <p>Lead Developer</p>
            </div>
            <div class="team-member">
                <img src="<?=base_url('assets/images/tan.jpg')?>" alt="Team Member 2">
                <h3>Jayvee Tan</h3>
                <p>Backend Developer</p>
            </div>
            <div class="team-member">
                <img src="<?=base_url('assets/images/saguinsin.jpg')?>" alt="Team Member 3">
                <h3>Vhinz Henry Saguinsin</h3>
                <p>Frontend Developer</p>
            </div>
            <div class="team-member">
                <img src="<?=base_url('assets/images/gabriel.jpg')?>" alt="Team Member 4">
                <h3>Arcy Gabriel</h3>
                <p>UI/UX Designer</p>
            </div>
            <div class="team-member">
                <img src="<?=base_url('assets/images/nepomuceno.jpg')?>" alt="Team Member 5">
